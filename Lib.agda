...
--note: it includes
--a)base type [Type];
--b)two-level type [AType];
--c)submodule "Subsumption";
--d)submodule "Others".
--------------------------- 
...
-----------------------------------
--module "TwoLevelTypes-Simp-PS"
--note: well-formedness restriction
--      is incorporated into types
--a)base type [Type];
--b)two-level type [AType];
--c)extended with pairs and sums.
----------------------------------- 
module TwoLevelTypes-Simp-PS where
