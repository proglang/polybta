...
open import Data.Fin public using (Fin ; Fin′ ; inject₁ ; inject ; toℕ)
  renaming (suc to fsuc ; zero to fzero ;
            compare to fcompare ; Ordering to FOrdering ; less to fless ; equal to fequal ; greater to fgreater)
open import Data.Vec public using (Vec ; lookup ; [])
  renaming (_∷_ to cons  ; map to vmap)
